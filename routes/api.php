...
Route::middleware('auth')->group(function(){Route::get('/trades',[TradingController::class,'trades']);Route::get('/assets',[TradingController::class,'assets']);Route::post('/trades',[TradingController::class,'storeTrade']);Route::post('/deposits',[TradingController::class,'storeDeposit']);Route::post('/admin/deposits/{deposit}/approve',[TradingController::class,'approveDeposit']);Route::post('/admin/trades/{trade}/accept',[TradingController::class,'acceptTrade']);});
