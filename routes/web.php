...
Route::get('/', fn () => view('trading.index',['prices'=>PriceSnapshot::latest()->get()->unique('symbol'),'buys'=>Trade::where('side','buy')->latest('traded_at')->take(20)->get(),'sells'=>Trade::where('side','sell')->latest('traded_at')->take(20)->get()]));
