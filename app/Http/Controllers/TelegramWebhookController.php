...
class TelegramWebhookController extends Controller
{
    ...
    {
        return [[
            ['text' => 'طلای ۹۹۵', 'callback_data' => "$prefix:gold_995"], ['text' => 'طلای ۹۹۹.۹', 'callback_data' => "$prefix:gold_9999"],
        ], [
