...
return [
    'talaboard' => [
        ...
        'prices_timeout' => env('TALABOARD_PRICES_TIMEOUT', 2),
    ...
    'telegram' => [
        ...
        'webhook_queue' => env('TELEGRAM_WEBHOOK_QUEUE', 'background'),
        'connect_timeout' => env('TELEGRAM_CONNECT_TIMEOUT', 1),
        'timeout' => env('TELEGRAM_TIMEOUT', 2),
