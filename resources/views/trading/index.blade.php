...
setUnits(tradeAsset,tradeUnit,tradeQty,tradePrice);setMinimumQuantity(tradeUnit,tradeQty);tradeAsset.onchange=()=>{setUnits(tradeAsset,tradeUnit,tradeQty,tradePrice);setMinimumQuantity(tradeUnit,tradeQty)};tradeUnit.onchange=()=>{setMinimumQuantity(tradeUnit,tradeQty);setPrice(tradeAsset,tradeUnit,tradePrice)};
